<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmBEFTNLogin.aspx.vb" Inherits="frmBEFTNLogin" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>.::BEFTN:Login::.</title>
    <link href="./Sources/css/Loginstyle.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <!--WRAPPER-->
    ...
    <div id="wrapper">
        ...
        <!--END SLIDE-IN ICONS-->
        <!--LOGIN FORM-->
        <form name="login-form" runat="server" class="login-form" action="" method="post">
        ...
        <%--<asp:Login ID="logInCtrl" runat="server" FailureText="Login failed. Please try again."
            ...
            <LayoutTemplate>--%>
                ...
                <div class="header">
                    ...
                    <!--END TITLE-->
                    <!--DESCRIPTION-->
                    <span>Login with your windows ID</span><!--END DESCRIPTION-->
                </div>
                <!--END HEADER-->
                <!--CONTENT-->
                <div class="content">
