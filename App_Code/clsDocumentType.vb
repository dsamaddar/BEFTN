...
#Region " Insert Update Document Type "
    Public Function fnInsertDocumentType(ByVal DocType As clsDocumentType, ByVal con As SqlConnection) As Integer
        Try
    ...
    Public Function fnUpdateDocumentType(ByVal DocType As clsDocumentType, ByVal con As SqlConnection) As Integer
        Try
...
#Region " Show Document Type "
    Public Function fnShowDocumentType(ByVal con As SqlConnection) As DataSet
    ...
    Public Function fnShowDocumentTypeByID(ByVal DocTypeID As String, ByVal con As SqlConnection) As clsDocumentType
